...
import { CreateWalletRequest, GetWalletsResponse } from '@/@types/wallet'
...
const createWallet =
  (config: Promise<AxiosRequestConfig>) => async (data: CreateWalletRequest) =>
    whiscashApi.post('/wallet', data, await config)
